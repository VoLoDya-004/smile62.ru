...
<script src="./javascripts/backToTop.js"></script>
	...
	<div id="progressBar"></div>
		...
		<div class="basket__empty">
			<b class="basket__empty_str1">В корзине пока пусто</b><br>
			<div class="basket__empty_str2">Загляните на главную — собрали там товары, которые могут вам понравиться</div><br>
			<a href="/"><button id="main"><b>Перейти на главную</b></button></a>
		</div>
	</section></div>
