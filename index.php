...
<body> 
	...
	<div id="progressBar"></div>
																	<!--основной контент-->
<main id="content">
		<h1 class="subtitle">Каталог</h1>
		<hr class="hr-line">
<span class="product">Товары</span>

<?php
$query = "select * from tovar order by id";
/* Создаем соединение */
...
//$count = mysqli_num_rows($result);
																	//карточки///
	echo '<div id= "catalog" class="setka">';
...
?>
	...
	<div class="load-more"><button id="load-more__btn" onclick="loadCards()">загрузить ещё</button></div>
	<div class="menu-mobile">
		<a href="/" style="display:block;" class="menu-mobile__item_active">
