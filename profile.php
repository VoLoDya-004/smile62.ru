...
<script src="./javascripts/backToTop.js"></script>
	...
	<div id="progressBar"></div>
		<div id="content">
			...
			<span class="form__header"><b>РЕГИСТРАЦИЯ</b></span>
				<p style="margin-top:-10px;">
					<label>Введите имя<br>
					<input type="text" class="form__registration_item" required>
					</label>
				</p>
				<p>
    				<label>Введите e-mail<br>
    				<input type="email" class="form__registration_item" required>
					</label>
  				</p>
				<p>
    				<label>Введите пароль<br>
    				<input type="password" class="form__registration_item" required>
					</label>
  				</p>
				<p>
				...
				<p>
					<button type="submit" class="form__registration_btn" id="form__registration_btn"><b>Зарегистрироваться</b></button>
				</p>
			</form>

			<form action="" method="post" class="form__entrance">
			<span class="form__header"><b>ВХОД</b></span>	
				<p style="margin-top:-10px;">
    				<label>Введите e-mail<br>
    				<input type="email" class="form__entrance_item" required>
					</label>
  				</p>
				<p class="form__entrance_item" style="margin-bottom:auto;margin-top:16px;">
    				<label>Введите пароль<br>
    				<input type="password" class="form__entrance_item" required>
					</label>
  				</p>
				<p>
					<button type="submit" class="form__entrance_btn" id="form__entrance_btn"><b>Войти</b></button>
				</p>
			</form>
			</section>
			<div class="recommendation"><b>Рекомендации</b></div>
		</div>
